...
export const emergencyIssues: EmergencyIssue[] = [
  { id: 1, title: 'No Cooling', desc: 'AC stopped blowing cold air in extreme heat. We prioritize these calls; same-day guaranteed.', icon: 'thermometer', urgency: 'Critical' },
  { id: 2, title: 'No Heat', desc: 'Furnace or heat pump failure during freezing temps. We dispatch immediately, 24/7.', icon: 'flame', urgency: 'Critical' },
  { id: 3, title: 'Water Leaking', desc: 'Condensate line clog or coil freeze causing water damage. Fast response prevents costly repairs.', icon: 'droplet', urgency: 'High' },
  { id: 4, title: 'Burning Smell', desc: 'Electrical burning odor from your HVAC unit. Turn off system and call; we arrive within 60 minutes.', icon: 'alert', urgency: 'Emergency' },
  { id: 5, title: 'Frozen Coil', desc: 'Ice buildup on outdoor or indoor coil signals airflow or refrigerant issues. We diagnose and fix same-day.', icon: 'snowflake', urgency: 'High' },
  { id: 6, title: 'System Not Running', desc: 'Complete system failure; no response from thermostat or unit. Emergency dispatch available.', icon: 'power', urgency: 'Critical' },
];
...
export const truckEquipment: string[] = [
