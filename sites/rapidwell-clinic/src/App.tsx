...
function Hero({ selectedVisit, waitTime, queueLength }: { selectedVisit: VisitType; waitTime: number; queueLength: number }) {
  return (
    <section className="relative overflow-hidden bg-gradient-to-br from-white via-slate-50 to-blue-50 pt-20 pb-16 md:pt-28 md:pb-24">
      <div className="absolute inset-0 opacity-10" style={{ backgroundImage: `url(${heroImage})`, backgroundSize: 'cover', backgroundPosition: 'center' }}></div>
...
function Treatments() {
  return (
    <section id="treatments" className="py-16 md:py-24 bg-slate-50 relative overflow-hidden">
      <div className="absolute inset-0 opacity-[0.06]" style={{ backgroundImage: `url(${clinicInteriorImage})`, backgroundSize: 'cover', backgroundPosition: 'center' }}></div>
...
function VisitFlowSection() {
  return (
    <section id="flow" className="py-16 md:py-24 bg-white relative overflow-hidden">
      <div className="absolute right-0 top-0 w-1/3 h-full opacity-[0.05]" style={{ backgroundImage: `url(${treatmentImage})`, backgroundSize: 'cover', backgroundPosition: 'center' }}></div>
      <div className="max-w-6xl mx-auto px-5 relative z-10">
        <div className="text-center mb-12">
