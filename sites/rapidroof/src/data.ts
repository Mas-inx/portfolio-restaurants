...
export const inspectionSteps: InspectionStep[] = [
  { step: '01', title: 'Book Online or Call', description: 'Schedule a same-day or next-day inspection. Emergency calls are answered 24/7 by a live dispatcher.', icon: 'phone' },
  { step: '02', title: 'Thorough Inspection', description: 'We inspect roof, gutters, flashing, soffit, fascia, and attic ventilation. Photo documentation included.', icon: 'search' },
  { step: '03', title: 'Detailed Quote', description: 'You receive a written estimate with photos, material breakdown, timeline, and warranty terms before any work begins.', icon: 'clipboard' },
  { step: '04', title: 'Repair or Replace', description: 'Work is scheduled within 48 hours for repairs. Full replacements are typically completed in 1–3 days.', icon: 'hammer' },
]
...
export const trustPoints = [
  { title: 'Licensed & Insured', description: 'Illinois licensed roofing contractor with $2M liability coverage and full workers compensation.', icon: 'shield' },
  { title: 'Warranty Backed', description: 'All work carries a minimum 5-year workmanship warranty. Manufacturer warranties on materials up to 50 years.', icon: 'shield' },
  { title: 'Rapid Response', description: 'Emergency calls answered 24/7. On-site within 4 hours for urgent repairs. No voicemail — you get a person.', icon: 'clock' },
  { title: 'Insurance Friendly', description: 'We document everything for your claim and work directly with your adjuster. Most claims approved within a week.', icon: 'checkmark' },
  { title: 'Free Estimates', description: 'All inspections and estimates are free. No obligation, no pressure, no hidden fees.', icon: 'checkmark' },
  { title: '4.8 Stars, 480+ Reviews', description: 'Rated 4.8 across Google, Yelp, and Angi. Every review is a real homeowner we served.', icon: 'star' },
]
